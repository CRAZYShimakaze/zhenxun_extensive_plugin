...
prop_list = {"FIGHT_PROP_BASE_ATTACK": "基础攻击力", "FIGHT_PROP_BASE_DEFENSE": "基础防御力", "FIGHT_PROP_BASE_HP": "基础生命值", "FIGHT_PROP_ATTACK": "攻击力",
    ...
    "FIGHT_PROP_DEFENSE_PERCENT": "百分比防御力", "FIGHT_PROP_ELEMENT_MASTERY": "元素精通", "FIGHT_PROP_CRITICAL": "暴击率", "FIGHT_PROP_CRITICAL_HURT": "暴击伤害",
    "FIGHT_PROP_ANTI_CRITICAL": "暴击抗性", "FIGHT_PROP_CHARGE_EFFICIENCY": "元素充能效率", "FIGHT_PROP_FIRE_SUB_HURT": "火元素抗性",
    "FIGHT_PROP_ELEC_SUB_HURT": "雷元素抗性", "FIGHT_PROP_ICE_SUB_HURT": "冰元素抗性", "FIGHT_PROP_WATER_SUB_HURT": "水元素抗性",
    "FIGHT_PROP_WIND_SUB_HURT": "风元素抗性", "FIGHT_PROP_ROCK_SUB_HURT": "岩元素抗性", "FIGHT_PROP_GRASS_SUB_HURT": "草元素抗性",
            ...
            for skill in data['skillLevelMap']:
                if skill[-1] == '1':
                    if role_info_json[role_name]['武器'] == '单手剑':
                        ...
                        skill_detail = {'等级': data['skillLevelMap'][skill], '图标': 'Skill_A_02'}
                    elif role_info_json[role_name]['武器'] == '长柄武器':
                        skill_detail = {'等级': data['skillLevelMap'][skill], '图标': 'Skill_A_03'}
